    ...
    try {
        ...
        await ctx.replyWithPhoto('https://t.me/DagEagleTour/9', {
            ...
            reply_markup: Markup.inlineKeyboard([
                [Markup.button.callback('Записаться', 'tour_1')]
            ])
        });
        ...
        await ctx.replyWithPhoto('https://t.me/DagEagleTour/10', {
            ...
            reply_markup: Markup.inlineKeyboard([
                [Markup.button.callback('Записаться', 'tour_2')]
            ])
        });
        ...
        await ctx.replyWithPhoto('https://t.me/DagEagleTour/8', {
            ...
            reply_markup: Markup.inlineKeyboard([
                [Markup.button.callback('Записаться', 'tour_3')]
            ])
        });
    } catch (error) {
...
const tours = async (ctx) => {
    try { 
        await ctx.replyWithMediaGroup([
            {
                type: 'photo',
                media: { url: 'https://t.me/DagEagleTour/13' },
                ...
                reply_markup: Markup.inlineKeyboard([
                    [Markup.button.callback('Записаться', 'tour_4')]
                ])
            },
            {
                type: 'photo',
                media: { url: 'https://t.me/DagEagleTour/11' },
                ...
                reply_markup: Markup.inlineKeyboard([
                    [Markup.button.callback('Записаться', 'tour_5')]
                ])
            },
            {
                type: 'photo',
                media: { url: 'https://t.me/DagEagleTour/12' },
                ...
                reply_markup: Markup.inlineKeyboard([
                    [Markup.button.callback('Записаться', 'tour_6')]
                ])
            }
        ]);
    } catch (error) {
