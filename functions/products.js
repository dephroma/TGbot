...
//         {
//             type: 'photo',
//             media: { url: 'https://vk.com/photo-226855768_457239052' },
...
//         {
//             type: 'photo',
//             media: { url: 'https://vk.com/photo-226855768_457239056' },
...
//         {
//             type: 'photo',
//             media: { url: 'https://vk.com/photo-226855768_457239057' },
...
const excurses = async (ctx) => {
    try {
        // Пример загрузки изображения и его отправки
        const imagePath1 = path.join(__dirname, 'image1.jpg');
        await downloadImage('https://vk.com/photo-226855768_457239052', imagePath1);

        const imagePath2 = path.join(__dirname, 'image2.jpg');
        await downloadImage('https://vk.com/photo-226855768_457239056', imagePath2);

        const imagePath3 = path.join(__dirname, 'image3.jpg');
        await downloadImage('https://vk.com/photo-226855768_457239057', imagePath3);

        // Отправка фото
        await ctx.replyWithMediaGroup([
            { type: 'photo', media: { source: imagePath1 }, caption: 'Описание фото 1' },
            { type: 'photo', media: { source: imagePath2 }, caption: 'Описание фото 2' },
            { type: 'photo', media: { source: imagePath3 }, caption: 'Описание фото 3' }
        ]);
    } catch (error) {
        console.error('Ошибка при загрузке фото:', error);
        await ctx.reply('Приветственное фото временно недоступно, но это не помешает нам начать! 😊');
