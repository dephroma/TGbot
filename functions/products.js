...
const tours = async (ctx) => {
    try {
        ...
        await ctx.replyWithPhoto('https://t.me/DagEagleTour/13', {
            ...
            reply_markup: Markup.inlineKeyboard([
                [Markup.button.callback('Записаться на тур "Край мечты"', 'tour_4')]
            ]).reply_markup
        });
        ...
        await ctx.replyWithPhoto('https://t.me/DagEagleTour/11', {
            ...
            reply_markup: Markup.inlineKeyboard([
                [Markup.button.callback('Записаться на тур "Весь Дагестан"', 'tour_5')]
            ]).reply_markup
        });
        ...
        await ctx.replyWithPhoto('https://t.me/DagEagleTour/12', {
            ...
            reply_markup: Markup.inlineKeyboard([
                [Markup.button.callback('Записаться на тур "Дагестанский вояж"', 'tour_6')]
            ]).reply_markup
        });
    } catch (error) {
        console.error('Ошибка при загрузке фото:', error);
