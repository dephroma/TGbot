...
//         await ctx.reply('https://vk.com/@dageagletour',  'https://example.com/photo.jpg')
...
//     await sendMessageWithDelay(ctx, 'https://vk.com/@dageagletour',  'https://example.com/photo.jpg', buttons);
// };

// const infoHandler = async (ctx) => {
//     await ctx.reply('Вся информация об экскурсиях представлена по ссылке ниже.👇\n' +
//         'В статьях вы найдете детали маршрутов, программы и важные нюансы.\n' +
//         'Пожалуйста, ознакомьтесь с материалами. Если появятся вопросы, мы всегда на связи!\n\n' +
//         'https://vk.com/@dageagletour');

//         await new Promise(resolve => setTimeout(resolve, 1000)); // Задержка на 1 секунду

//         await ctx.reply('https://vk.com/@dageagletour',  'https://example.com/photo.jpg', Markup.keyboard([
//             ['💰 Условия оплаты и бронирование'],
//             ['❓ Часто задаваемые вопросы'],
//             ['⬅ Назад']
//         ])
