...
const faqHandler = (ctx) => {
    ctx.reply('❓❓❓ Часто задаваемые вопросы (FAQ)\n\n' +
        'для вашего удобства мы собрали в одной статье' +
        'https://telegra.ph/CHastye-voprosy-FAQ-03-03', Markup.keyboard([
            ['📚 Каталог и бронирование'],
            ['🔙 Назад']
    ]).resize());
};
...
//     try {
//         await ctx.reply('Салам, вацок! Добро пожаловать! 👋\nВыбери действие из меню:', mainMenu);
//     } catch (error) {
//         console.error('Ошибка в greetingHandler:', error);
//         await ctx.reply('Ошибка при обработке команды. Попробуй позже.');
//     }
// }
...
module.exports = { catalogHandler, datesPriceHandler, faqHandler };